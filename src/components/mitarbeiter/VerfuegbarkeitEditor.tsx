...
export interface VerfuegbarkeitEditorRef {
  /** Speichert Verfügbarkeiten falls ungespeicherte Änderungen vorliegen. */
...
export const VerfuegbarkeitEditor = forwardRef<VerfuegbarkeitEditorRef, VerfuegbarkeitEditorProps>(
  function VerfuegbarkeitEditor({ mitarbeiterId, disabled }, ref) {
